...
export default function CounselorRecordReview({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Form State for the editable parts of the document
          ...
          <div className="lg:col-span-8 bg-white border border-gray-300 shadow-xl p-8 md:p-12 text-black max-w-[800px] mx-auto w-full">
            ...
            <div className="flex justify-between items-start border-b-2 border-slate-900 pb-6 mb-8">
              ...
              <div className="text-right text-xs text-slate-600 space-y-1.5 font-mono">
                <p><span className="font-bold text-slate-400">ID:</span> {record._id.substring(0, 8).toUpperCase()}</p>
                <p><span className="font-bold text-slate-400">STUDENT:</span> {record.student?.studentId}</p>
            ...
            {/* Official Footer */}
            <div className="mt-16 pt-6 border-t-2 border-slate-900 flex justify-between items-end opacity-50">
              <div className="text-[10px] text-slate-500 font-mono space-y-1">
                <p>SYSTEM: University Matrix Core v2.0</p>
                <p className="uppercase text-slate-400">Strictly Confidential</p>
              </div>
              <div className="text-center">
                <div className="w-32 border-b border-slate-400 mb-2"></div>
                <p className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">Counselor Signature</p>
              </div>
            </div>
