    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center space-x-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Counselor Settings</h1>
            <p className="text-gray-600 mt-1">Manage your professional details and counseling parameters.</p>
          </div>
        </div>
          ...
          <form onSubmit={handleUpdateProfile} className="space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <input type="text" disabled className="w-full px-3 py-2 border border-gray-200 rounded-md bg-gray-50 text-gray-500 cursor-not-allowed" value={employeeId} />
              </div>
            </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Areas of Expertise (Counseling Range)</label>
              <textarea 
                rows={3}
            ...
            <div className="pt-6 flex justify-end">
              <button type="submit" disabled={status === "saving"} className="flex items-center px-6 py-2 bg-indigo-600 text-white rounded-md font-medium hover:bg-indigo-700 disabled:bg-indigo-400 transition-colors">
